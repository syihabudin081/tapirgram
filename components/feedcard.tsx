    ...
    <div className="mt-3 bg flex flex-col">
            <div className="mt-3">
              <Image
                ...
                height={600}
              />
              <div className="bg-black shadow p-5 text-base text-white font-semibold">
                A Pretty Cool photo from the mountains. Image credit to
                @danielmirlea on Unsplash.
              </div>
              <div className="bg-black p-1 shadow flex flex-row flex-wrap justify-evenly ">
                <svg
              ...
              <div className="bg-black  border-white rounded-b-lg shadow p-5 text-sm text-white content-center font-semibold flex flex-row flex-wrap">
